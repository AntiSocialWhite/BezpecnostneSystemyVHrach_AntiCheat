...
public:
	...
	virtual const void world_to_screen_matrix() = 0; // was matrix
	virtual const void WorldToViewMatrix() = 0; // was matrix, not needed for us
	...
	virtual int                   GetFrustumList(vec3_t** pList, int listMax) = 0;
	virtual bool                  ShouldUseAreaFrustum(int i) = 0;
	virtual void                  SetAudioState(const AudioState_t& state) = 0;
	virtual int                   SentenceGroupPick(int groupIndex, char* namee, int nameBufLen) = 0;
	virtual int                   SentenceGroupPickSequential(int groupIndex, char* namee, int nameBufLen, int sentenceIndex, int reset) = 0;
	virtual int                   SentenceIndexFromName(const char* pSentenceName) = 0;
	virtual const char* SentenceNameFromIndex(int sentenceIndex) = 0;
	virtual int                   SentenceGroupIndexFromName(const char* pGroupName) = 0;
	virtual const char* SentenceGroupNameFromIndex(int groupIndex) = 0;
	virtual float                 SentenceLength(int sentenceIndex) = 0;
	virtual void                  ComputeLighting(const vec3_t& pt, const vec3_t* pNormal, bool bClamp, vec3_t& color, vec3_t* pBoxColors = NULL) = 0;
	...
	virtual void                  DebugDrawPhysCollide(const CPhysCollide* pCollide, IMaterial* pMaterial, const matrix_t& transform, const uint8_t* color) = 0; //79
	...
	virtual void                  execute_cmd(const char* szCmdString) = 0; //108
	...
	virtual void                  SphereTracePaintSurface(const model_t* model, const vec3_t& position, const vec3_t& vec2, float radius, /*CUtlVector<unsigned char, CUtlMemory<unsigned char, int>>*/ int& utilVecShit) = 0;
